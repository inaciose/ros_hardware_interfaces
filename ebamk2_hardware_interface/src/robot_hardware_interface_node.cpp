#include <ebamk2_hardware_interface/robot_hardware_interface.h>
...
void robotHardwareInterface::read() {
    ...
    //joint_position_[0] = angles::from_degrees(joint_position_command_[0]);
    //joint_position_[1] = angles::from_degrees(joint_position_command_[1]);
    //joint_position_[2] = angles::from_degrees(joint_position_command_[2]);
    //joint_position_[3] = angles::from_degrees(joint_position_command_[3]);
}
